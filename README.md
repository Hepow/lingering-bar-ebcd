...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lingering-bar-ebcd)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-bar-ebcd
```

A live public deployment of this template is available at [https://lingering-bar-ebcd.templates.workers.dev](https://lingering-bar-ebcd.templates.workers.dev)
